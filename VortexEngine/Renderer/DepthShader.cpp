...
bool DepthShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"Shaders/Shadow.fx", L"Shaders/Shadow.fx");
	if (!result)
	{
		return false;
	}
...
bool DepthShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX& worldMatrix, XMMATRIX& lightprojectionMatrix, XMMATRIX& lightViewMatrix, int indexCount)
{
...
bool DepthShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DCompileFromFile(vsFilename, NULL, NULL, "ShadowMapVS", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
	...
	result = D3DCompileFromFile(psFilename, NULL, NULL, "ShadowMapPS", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
